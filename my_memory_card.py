...
questions_list.append(Question("Государственный язык Казахстана", 'Португальский', 'Русский', 'Казахский', 'Итальянский'))
questions_list.append(Question("Государственный язык Японий", 'Португальский', 'Хинди', 'Японский', 'Итальянский'))
